...
public class UserProfileUseCaseTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    */
    public void testEditUser() {
        ...
        solo.enterText((EditText) solo.getView (R.id.vehicle_description_edit_text), "");
        solo.clickOnView(editProfile);
    }
    ...
    */
    public void testSwitchDriver() {
        ...
        userManager.getUser().setVehicleDescription("");
        ...
        solo.enterText(solo.getEditText("Vechicle Make"), "SUV");
